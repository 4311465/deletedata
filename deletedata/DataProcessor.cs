...
namespace deletedata
{
    ...
    public class DataProcessor
    {
        ...
        #region
        public async Task ProcessAndUpdateDataAsync(Dictionary<string, string> keyValuePairs, string connectionString, string tablePrefix, string tableEnd, DateTime mintime, DateTime maxtime, string databaseName = "aq_traces", double min = 0.5, double max = 100,double maxvalue=0.5)
        {
            ...
            try
            {
                ...
                //2. 处理数据并构建更新语句
                var updateCommands = await ProcessDataAndBuildUpdatesAsync(dataToUpdate, tablePrefix, tableEnd, databaseName,maxvalue);
        ...
        private async Task<List<string>> ProcessDataAndBuildUpdatesAsync(List<DataRecord> records, string tablePrefix, string tableEnd, string databaseName = "aq_traces",double alarmalue = 0.5)
        {
        ...
        #region
        public async Task ProcessAndUpdateDataRecordAsync(Dictionary<string, string> keyValuePairs, string connectionString, string tablePrefix, string tableEnd, DateTime mintime, DateTime maxtime, string databaseName = "aq_traces", double min = 0.5, double max = 100,double maxvalue=0.5)
        {
            InitializeValueEncryptMapping(keyValuePairs, connectionString);
            try
            {
                ...
                Log.Information($"需要更新 {dataToUpdate.Count} 条记录");
                //2. 处理数据并构建更新语句
                var updateCommands = await ProcessDataRecordAndBuildUpdatesAsync(dataToUpdate, tablePrefix, tableEnd, databaseName, maxvalue);
        ...
        private async Task<List<string>> ProcessDataRecordAndBuildUpdatesAsync(List<DataRecord_Record> records, string tablePrefix, string tableEnd, string databaseName = "aq_traces",double alarmalue=0.5)
        {
            var updateCommands = new List<string>();
        ...
        #region
        public async Task ProcessAndUpdateDataMinusAsync(Dictionary<string, string> keyValuePairs, string connectionString, string tablePrefix, string tableEnd, DateTime min, DateTime max, string databaseName = "aq_traces",  double maxvalue = 0.5)
        {
            InitializeValueEncryptMapping(keyValuePairs, connectionString);
            try
            {
                ...
                Log.Information($"需要更新 {dataToUpdate.Count} 条记录");
                //2. 处理数据并构建更新语句
                var updateCommands = await ProcessDataMinusAndBuildUpdatesAsync(dataToUpdate, tablePrefix, tableEnd, databaseName, maxvalue);
        ...
        private async Task<List<DataRecord_Minus>> QueryDataMinusForProcessingAsync(string tablePrefix, string tableEnd, DateTime min, DateTime max, string databaseName = "aq_traces")
        {
            ...
            string query = $@"
                SELECT 
                    ...
                    where `UniqueId` like '{tablePrefix}%'   and  `UpdateTime` BETWEEN '{min}' and '{max}' and `Status` != 2147483850
        ...
        private async Task<List<string>> ProcessDataMinusAndBuildUpdatesAsync(List<DataRecord_Minus> records, string tablePrefix, string tableEnd, string databaseName = "aq_traces", double alarmalue = 0.5)
        {
            var updateCommands = new List<string>();
        ...
        #region
        public async Task ProcessAndUpdateDataHoursAsync(Dictionary<string, string> keyValuePairs, string connectionString, string tablePrefix, string tableEnd, DateTime min, DateTime max, string databaseName = "aq_traces", double maxvalue = 0.5)
        {
            InitializeValueEncryptMapping(keyValuePairs, connectionString);
            try
            {
                ...
                Log.Information($"需要更新 {dataToUpdate.Count} 条记录");
                //2. 处理数据并构建更新语句
                var updateCommands = await ProcessDataHoursAndBuildUpdatesAsync(dataToUpdate, tablePrefix, tableEnd, databaseName, maxvalue);
        ...
        private async Task<List<string>> ProcessDataHoursAndBuildUpdatesAsync(List<DataRecord_Hours> records, string tablePrefix, string tableEnd, string databaseName = "aq_traces", double alarmalue = 0.5)
        {
            var updateCommands = new List<string>();
            var validUpdates = new List<(long RecordId, double OldMaxValue, double NewMaxValue, double OldAvgValue, double NewAvgValue,
                double OldMinValue, double NewMinValue, long OldStatus, long NewStatus)>();
